...
public class Skyline extends World
{
    ...
    public void act() {
        ...
        setActOrder(StartScreen.class,Skyline.class,Alpaca.class);
        ...
        //Changed winning the game after 60 seconds since it's not that challenging
        if ((counter % 3600) == 0)
        {
            Win Hahaha = new Win();
